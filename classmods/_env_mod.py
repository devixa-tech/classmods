...
HEADER = """
# =============================================================================
# This file was automatically generated by ENVMod.
# Only uncomment and modify the value fields. Do not change the comments,
# section names, or the overall layout - they will be overwritten on the
# next generation.
#
# How to Use:
#   Uncomment a setting by removing the leading '#' from the line.
#   Set the desired value after the '=' sign.
#   Lines that stay commented out (starting with '#') are ignored by the loader.
#
# IMPORTANT: Empty values (e.g., KEY=) are INTENTIONALLY treated as empty strings ('').
#   This is the intended behavior.
#   Previously, empty values were treated as None. If you rely on that old behavior,
#   please update your env accordingly.
# =============================================================================
""".strip()

FOOTER = """
# =============================================================================
# Powered by ENVMod@Devixa-Tech
# =============================================================================
""".strip()
...
class ENVMod:
    ...
    def save_file(cls, path: str = ".env", with_values: bool = False) -> None:
        ...
        """
        file_content = f"{HEADER}\n\n{cls._envfile._generate(with_values)}\n{FOOTER}"
